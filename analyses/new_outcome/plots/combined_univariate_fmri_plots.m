...
fprintf(fid,[' We ranked '...
    ...
    'separating the three SOZ lateralities. Fig. 2A shows the effect size of the top %d ranked features. '...
...
fprintf(fid,['We next compared the set of features that best distinguished '...
    ...
    'For each of the two classification questions, '...
    'we ranked features in descending order by their effect size (|Cohen''s <i>d</i>|). Fig. 2B '...
...
fprintf(fid,['We asked whether fMRI connectivity asymmetry similarly distinguished left, right, '...
    'and bilateral SOZs.']);
...
fprintf(fid,[' We measured the fMRI BOLD correlation between all ipsilateral temporal regions, separately for '...
    'the left and the right. Fig. 2C shows the left temporal DKT atlas regions included for fMRI connectivity '...
    'analysis.']);
...
fprintf(fid,[' We compared the fMRI connectivity AI between '...
    'patients with left-sided, right-sided, and bilateral SOZs (Fig. 2D). '...
...
fprintf(fid,['Similar to the result for interictal EEG data, this suggests that fMRI temporal lobe connectivity '...
    'AI distinguishes patients with left from bilateral SOZs, but cannot clearly '...
