...
fprintf(fid,[' We defined the fMRI connectivity AI using the same method as for '...
    ...
    'patients with left-sided SOZs, right-sided SOZs, and bilateral SOZs (Fig. 3D). '...
...
annotation('textbox',[0.51 0.9 0.1 0.1],'String','B','LineStyle','none','fontsize',25)
annotation('textbox',[0 0.33 0.1 0.1],'String','C','LineStyle','none','fontsize',25)
annotation('textbox',[0.51 0.33 0.1 0.1],'String','D','LineStyle','none','fontsize',25)
