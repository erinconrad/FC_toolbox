...
fid = fopen(fname,'a');
fprintf(fid,'<p><br><b>Many interictal EEG features are highly correlated, and choice of reference affects features</b></br>');
...
fprintf(fid,['For this analysis, we studied only the mean feature across all sleep stages ('...
    'as opposed to separately examining sleep and wake, or also examining the feature standard deviation '...
    ...
    'number of features times the number of references (3). Fig. 2A shows the '...
...
fprintf(fid,['Fig. 2B shows the mean (standard deviation) inter-reference feature correlation '...
    ...
    'suggesting that the choice of reference strongly influences interictal EEG feature calculations.</p>']);
...
fprintf(fid,['<p>We repeated this inter-feature correlation analysis, this time '...
    ...
    'Fig. 2C shows the inter-feature AI correlation, again restricting analysis to common '...
    'average reference. Again, we observed high inter-feature correlation for several features. '...
    'Fig. 2D shows the inter-reference AI correlation (there are no error bars because '...
    ' there is only a single correlation value across all patients, as opposed to the '... ...
    'analysis in Fig. 2B, where we demonstrate the average and standard deviation of the '...
    'correlation across patients). Again, we observed a high range of inter-reference correlations '...
    'across features. The machine-common average reference correlation tended to be the highest, '...
    'but this was not true for all features.</p>']);
