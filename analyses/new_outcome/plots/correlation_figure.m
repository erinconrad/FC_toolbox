...
fid = fopen(fname,'a');
fprintf(fid,'<p><br><b>Many interictal EEG features are highly correlated, and the choice of reference affects features</b></br>');
...
fprintf(fid,['<p>We repeated this inter-feature correlation analysis, this time '...
    ...
    'Again, we observed high variability inter-reference correlations '...
    'across features.</p>']);
