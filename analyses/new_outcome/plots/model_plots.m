...
%% Initialize figure
figure
set(gcf,'position',[1 1 1440 1400])
...
for is = 1:2
    ...
    title(sprintf('Spikes: Accuracy: %1.1f%%, balanced accuracy %1.1f%%',accuracy*100, balanced_accuracy*100))
    set(gca,'fontsize',15)
