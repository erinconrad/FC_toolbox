...
fprintf(fid,[' %d of %d (%1.1f%%) had good one-year Engel outcomes (defined as Engel I), '...
    'and %d of %d (%1.1f%%) had poor Engel outcomes (defined as Engel 2+) (Fig. 4A). '...
    '%d of %d (%1.1f%%) had good one-year ILAE outcomes (defined as ILAE 1-2), and '...
    '%d of %d (%1.1f%%) had poor ILAE outcomes (defined as ILAE 3+) (Fig. 4C).'],good_bad(1,1),...
...
fprintf(fid,[' We hypothesized that patients with a good surgical outcome would have a '...
    ...
    'Engel outcomes (%1.2f (%1.2f)) (<i>t</i>(%d) = %1.1f, %s) (Fig. 4B). Mean concordant model probability '...
    'was also significantly higher in patients with good ILAE outcomes (%1.2f (%1.2f)) than '...
...
fprintf(fid,['<p>We also asked if spike rate asymmetry adds additional information to '...
    ...
    'seizure generator based on the pre-implant data, with the hypothesis that a higher 5-SENSE '...
    'score, implying a higher pre-implant probability of a focal seizure generator, '...
    'would predict a better surgical outcome. We applied the 5-SENSE score to the same '...
    'patients studied in our primary outcome analysis, and used leave-one-patient-out cross-validation '...
    'to predict good vs. poor surgical outcome using a logistic regression model with the 5-SENSE score '...
    'as the only predictor. The 5-SENSE score predicted both Engel and ILAE outcome (AUC = %1.2f '...
    ...
    '(as defined in the above paragraph, reflecting the output of the spike rate model). '...
    ...
    'Overall, these results suggest that interictal EEG spike rate asymmetry predicts surgical outcome '...
    'in TLE, although it remains unclear how much information spike rate asymmetry adds over the pre-implant data.</p>'],...
