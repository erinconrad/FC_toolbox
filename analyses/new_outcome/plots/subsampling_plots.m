    ...
    for iss = 1:nss
        ...
        for id = 1:ndurs
            ...
            for is = 1:nsamples
                ...
                relevant_features = contains(features,sprintf('_way%d',curr_way)) & ...
                    contains(features,sprintf('_ss%d',curr_ss)) & ...
                    contains(features,sprintf('_dur%d',curr_dur)) & ...
                    contains(features,sprintf('_samp%d',curr_sample));
