...
for ia = 1:2
    ...
    if ia == 1
        ...
        'an estimate of the accuracy of predicting the SOZ based entirely on spatial location (Fig 4). '...
    ...
    fprintf(fid,[' We compared the performance of the null model against a model including connectivity '...
        ...
        'even a null model ignoring EEG data substantially outperforms a chance model (null model AUC = %1.2f, 95%% CI %1.2f-%1.2f). It also shows '...
