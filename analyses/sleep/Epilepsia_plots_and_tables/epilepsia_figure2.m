...
fprintf(fid,[' SleepSEEG automated sleep staging resulted in classifications '...
    ...
    ' the normalized ADR classifying SleepSEEG N3 from wake labels: 0.91). Not surprisingly,'...
...
fprintf(fid,[' Examination of spike rates by time of day revealed a non-uniform distribution'...
    ...
    'spike rates appear to peak in the early morning and have a nadir in the late morning,'...
...
U2 = nt*ne-U1;
U = min([U1,U2]);
fprintf(fid,['<p>We next tested how spike rates varied by epilepsy localization. There was no difference in spike rates between patients'...
