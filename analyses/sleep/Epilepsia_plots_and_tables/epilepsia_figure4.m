...
fprintf(fid,['<br>We asked whether patients demonstrated a circadian rhythm '...
    ...
    'demonstrating more seizures in the morning and afternoon (Supplemental Figure 2A).'],...
    z,get_p_html(pval));
...
fprintf(fid,[' Seizure rates were similar between sleep (median %1.3f seizures/day)'...
    ' and wake (median %1.3f seizures/day) (Wilcoxon signed-rank test: <i>T<sup>+</sup></i> = %1.1f, %s) (Supplemental Figure 2B).'],...
...
fprintf(fid,[' We performed a linear mixed effects model examining 169 seizures with '...
    ...
    'The estimate for the post-preictal spike rate difference was %1.1f (95%% CI %1.1f-%1.1f, %s). '...
    'There was no significant effect of semiology (Supplemental Table 4).<p>'],...
...
fprintf(sfid,['<p>Visually, there was no obvious preictal increase in spikes (Fig. 4A).'...
    ...
    '(Wilcoxon signed-rank test: <i>T<sup>+</sup></i> = %1.1f, %s) (Supplemental Figure 2C).'],...
    stats.medians(2),stats.medians(1),stats.Tpos,get_p_html(stats.pval));
