...
fprintf(fid,[' We performed a linear mixed effects model examining %d seizures from %d patients with '...
    ...
    'There was no significant effect of semiology on post-ictal spike rate change (Fig. 4D, Table S7).<p>'],...
...
fprintf(sfid,['<p>Visually, there was no obvious preictal increase in spikes (Fig. 4A).'...
