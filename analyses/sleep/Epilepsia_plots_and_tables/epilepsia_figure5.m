...
for ic = 1:2
    for jc = 1:2
        text(ic,jc,sprintf('%s:\n%d',conf_text{jc,ic},all_mat(jc,ic)),'horizontalalignment','center','fontsize',25,'fontweight','bold')
    end
end
title(sprintf(['All patients in aggregate\nAccuracy: %1.1f%%,'...
     ' PPV: %1.1f%%, NPV: %1.1f%%'],...
all_acc*100,...
all_mat(2,2)/(all_mat(2,1)+all_mat(2,2))*100,all_mat(1,1)/(all_mat(1,1)+all_mat(1,2))*100,...
