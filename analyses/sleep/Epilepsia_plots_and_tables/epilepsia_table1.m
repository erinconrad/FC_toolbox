...
fprintf(fid,['<p>18 out of 119 patients were excluded because the positive '...
    ...
    '101 patients had predominantly stereo-EEG implantation (76.2%) (Table 1). '...
    ' Across the 101 patients, we studied a total of %d minutes of EEG data, '...
    'containing a total of %d spikes across all electrodes, '...
    'and %d total seizures. '
    'The AUC comparing predicted sleep/wake classifications against manual '...
    'sleep/wake labels was 0.90 (Fig. 1D). Examining a sample of 50 random '...
    ...
    nansum(n_one_minute_segments),nansum(n_spikes),nansum(n_seizures));
