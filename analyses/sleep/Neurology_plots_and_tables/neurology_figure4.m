...
fprintf(fid,['<br>We asked whether patients demonstrated a circadian rhythm '...
    ...
    'of patients'' circular means: z = %1.1f, %s) (Supplemental Fig. 2A).'],...
    z,get_p_html(pval));
...
%% Add annotations
annotation('textbox',[0 0.92 0.1 0.1],'String','A','fontsize',25,'linestyle','none')
annotation('textbox',[0.33 0.92 0.1 0.1],'String','B','fontsize',25,'linestyle','none')
annotation('textbox',[0.67 0.92 0.1 0.1],'String','C','fontsize',25,'linestyle','none')
