function neuron_supplemental_fig1
...
fprintf(fid,[' There was no significant difference in sleep-wake spike rate difference between patients'...
    ...
    ' %1.1f, %s) (Supplementary Fig 1A).'],nanmedian(rate_diff(mt)),nanmedian(rate_diff(nc)),...
...
U2 = nt*ne-U1;
U = min([U1,U2]);
fprintf(fid,[' Patients with mesial temporal epilepsy had a greater '...
