function neuron_supplemental_fig2
...
fprintf(fid,[' The number of spike sequences was higher in sleep (median %1.1f spike sequences/min)'...
    ' than wake (median %1.1f spike sequences/min) (Wilcoxon signed-rank test: <i>T<sup>+</sup></i> = %1.1f, %s) (%sA).'],...
    stats.medians(2),stats.medians(1),stats.Tpos,get_p_html(stats.pval),fig_name);
...
fprintf(fid,[' The spike spread was also higher in sleep (median %1.1f spikes/sequence)'...
    ' than wake (median %1.1f spikes/sequence) (Wilcoxon signed-rank test: <i>T<sup>+</sup></i> = %1.1f, %s) (%sB).'],...
    stats.medians(2),stats.medians(1),stats.Tpos,get_p_html(stats.pval),fig_name);
...
fprintf(fid,[' To test a potential mechanism for the increased spike rates in sleep,'...
    ...
    ' than wake (median %1.1f) (Wilcoxon signed-rank test: <i>T<sup>+</sup></i> = %1.1f, %s) (%sC).</p>'],...
    stats.medians(2),stats.medians(1),stats.Tpos,get_p_html(stats.pval),fig_name);
