...
if ~doing_from_github
    pnas_figure1 % this needs a raw data file to run (which is large)
end

pnas_figure2

pnas_supplemental_fig1

pnas_supplemental_fig2
...
pnas_supplemental_fig3

if ~doing_from_github
    pnas_table1 % this needs a raw data file to run (which is large)
end
